"""
Django settings for litgo project.
...
SECRET_KEY = 'vt=oxw_x7k)mqo^wq**@46_plo0aaz*3gm@e*x^-$(-w6-&=$@'
...
WSGI_APPLICATION = 'litgo.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "topmenu_links": [
        ...
        {"name": "Litgo | Healthy Snackbar", "url": "home", "permissions": ["auth.view_user"]},
